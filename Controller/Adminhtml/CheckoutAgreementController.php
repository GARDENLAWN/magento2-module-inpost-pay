...
namespace InPost\InPostPay\Controller\Adminhtml;
...
class CheckoutAgreementController
{
    public const ADMIN_RESOURCE = 'InPost_InPostPay::checkoutagreement';
    ...
    protected function initPage(Page $resultPage): Page
    {
        $resultPage->setActiveMenu(self::ADMIN_RESOURCE)->addBreadcrumb(
            __('InPost Pay Terms And Conditions')->render(),
            __('InPost Pay Terms And Conditions')->render()
        );

...
class ValidateSubAgreementUsageInParentAgreementsBeforeDisableEventObserver extends Obsrv implements ObserverInterface
{
    ...
    public function execute(Observer $observer): void
    {
        ...
        if ($agreement instanceof InPostPayCheckoutAgreementInterface) {
            $this->validateSubAgreementUsageInParentAgreements($agreement);
        }
    }
}
